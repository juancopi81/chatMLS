...
hf_ds = "juancopi81/mls_ada_embeddings"
tokenizer = GPT2TokenizerFast.from_pretrained("gpt2")

HEADER = """Answer the question as truthfully as possible using the provided context, and if the answer is not contained within the text below, say "This is not covered in MLS." Try imitating the style of the provided context. \n\nContext:\n"""
...
def answer_query_with_context(
    ...
    if gpt_answer != "This is not covered in MLS.":
...
with block:
    gr.Markdown("""<h1><center>Chat with chatMLS</center></h1>
